				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="heading-section text-center animate-box">
							<h2>About Us</h2>
							<p>Here at RG Fitness we offer our customers the best information, the best equipment and the best trainers for the best results.
							RG Fitness is committed to offering top class gym and fitness class facilities at a fraction of the usual cost of health club membership, by removing the unnecessary frills.
							Our expert trainers will help you plan your fitness goals and give you the tools and techniques you need to succeed.</p>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							<h1 class="text-center">Train like a champion</h1>
							<p>RG Fitness will revolutionise the way you train. Our state of the art facilities will help you perfect your skills and get the best results possible.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="heading-section text-center animate-box">
							<h2>Our Partners</h2>
							<img src="images\blkbox.jpg" alt="blkbox logo" style="width="050" height="100";">
							<br></br>
